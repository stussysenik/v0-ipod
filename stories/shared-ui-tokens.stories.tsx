...
import { sharedUiTokens } from "@ipod/lib/support/shared-ui-tokens";
		...
		<div className="w-[min(860px,92vw)] space-y-6 text-left">
			<div className="space-y-2">
				...
				<p className="max-w-2xl text-sm leading-6 text-black/66">
					Update <code>tokens/shared-ui.json</code>, review the result
					here, then sync the JSON to Tokens Studio / Figma. This page
					exists so token edits are inspectable without opening the
					full app shell.
				</p>
			</div>
