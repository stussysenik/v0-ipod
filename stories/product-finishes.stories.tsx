...
} from "@ipod/lib/domain/color-manifest";
	...
	return (
		<div className="rounded-[20px] border border-black/10 bg-white/90 p-3 shadow-[0_14px_26px_rgba(0,0,0,0.06)]">
			...
			<div className="mt-3 space-y-1">
				...
				{note ? (
					<div className="text-xs leading-5 text-black/58">
						{note}
					</div>
				) : null}
			</div>
		...
		<div className="w-[min(1080px,94vw)] space-y-8 text-left">
			<section className="space-y-3">
				...
				<p className="max-w-3xl text-sm leading-6 text-black/66">
					This board mirrors the product-owned finish and backdrop
					data used by the iPod assembly. Use it when adjusting
					hardware finish direction or curated color defaults before
					reviewing the assembled device stories.
				</p>
			</section>
