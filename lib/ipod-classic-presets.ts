...
export const IPOD_CLASSIC_PRESETS: readonly IpodClassicPresetDefinition[] = [
	...
	},
	{
		...
		shell: {
			width: 350,
			height: 580,
			radius: 44, // More rounded corners as requested
			innerRadius: 43,
			paddingX: 18,
			paddingTop: 20,
			paddingBottom: 28,
		...
		screen: {
			frameWidth: 296,
			frameHeight: 222,
			outerRadius: 10, // Refined screen corner
			innerRadius: 8,
			statusBarHeight: 17,
			statusBarPaddingX: 8,
			contentHeight: 134,
		...
		wheel: {
			size: 264, // Expanded to be "more to the edge" (350 - 264 = 86 total margin, vs 128 previously)
			centerSize: 84,
			menuTopInset: "9%", // Labels closer to the edge
			sideInset: "9%",
			bottomInset: "10%",
			labelFontSize: 10.5,
