...
function PhysicalAssemblyShowcase({
  ...
  const [model, dispatch] = useReducer(ipodWorkbenchReducer, undefined, () => {
    ...
    return {
      ...
      interaction: {
        ...initial.interaction,
        interactionModel,
        osScreen: interactionModel === "direct" ? "now-playing" : initialScreen,
        menuIndex: 0,
      },
    };
  });
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at top, rgba(255,255,255,0.9) 0%, rgba(244,239,226,0.86) 38%, rgba(232,223,208,0.96) 100%)",
      }}
    >
      <IPodDeviceShell
        preset={activePreset}
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Repository-default review surface for the physical iPod assembly. Use this lane for hardware finish, screen chrome, and click-wheel fidelity work before checking the full workbench flow.",
      },
    },
  },
  args: {
