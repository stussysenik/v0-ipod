  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.18) 45%, rgba(0,0,0,0) 78%)",
        }}
        aria-hidden="true"
      />
        ...
        >
          ...
          <div
            ...
            style={{
              borderRadius: preset.shell.radius,
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.7), inset 1px 0 0 rgba(255,255,255,0.2), inset -1px 0 0 rgba(255,255,255,0.2)",
            }}
            aria-hidden="true"
          />
          ...
          {(showShadowLayer || exportSafe) && (
            <div
              ...
              style={{
                borderRadius: preset.shell.radius,
                boxShadow:
                  "0 20px 48px -28px rgba(0,0,0,0.4), 0 42px 64px -44px rgba(0,0,0,0.3)",
              }}
              aria-hidden="true"
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "inset 0 0 0 1px rgba(255,255,255,0.12), inset 0 -18px 32px rgba(0,0,0,0.04)",
            }}
            aria-hidden="true"
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(166deg, rgba(255,255,255,0.28) 0%, rgba(255,255,255,0.08) 22%, rgba(255,255,255,0) 60%)",
            }}
            aria-hidden="true"
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(0,0,0,0.08) 70%, rgba(0,0,0,0.12) 100%)",
            }}
            aria-hidden="true"
          />
