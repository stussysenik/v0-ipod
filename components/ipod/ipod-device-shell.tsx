	...
	return (
		...
		>
			<div
				...
				style={{
					background: "radial-gradient(circle, rgba(0,0,0,0.34) 0%, rgba(0,0,0,0.16) 42%, rgba(0,0,0,0) 74%)",
				}}
			/>
			<div
				aria-hidden="true"
				...
				>
					{(showShadowLayer || exportSafe) && (
						<div
							...
							style={{
								boxShadow: "0 20px 34px -24px rgba(0,0,0,0.42), 0 42px 58px -44px rgba(0,0,0,0.34)",
							}}
						/>
					)}
					<div
						...
						style={{
							boxShadow: "inset 0 0 0 1px rgba(255,255,255,0.1), inset 0 -14px 24px rgba(0,0,0,0.035)",
						}}
					/>
					<div
						aria-hidden="true"
						...
						style={{
							background: "linear-gradient(166deg, rgba(255,255,255,0.34) 0%, rgba(255,255,255,0.12) 18%, rgba(255,255,255,0) 54%)",
						}}
					/>
					<div
						aria-hidden="true"
						...
						style={{
							background: "linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(0,0,0,0.07) 74%, rgba(0,0,0,0.11) 100%)",
						}}
					/>
