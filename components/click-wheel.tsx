...
export function ClickWheel({ playClick, onSeek, onCenterClick, className, style }: ClickWheelProps) {
        ...
        return (
                <div
                        ref={wheelRef}
                        className={`relative w-[240px] h-[240px] cursor-grab active:cursor-grabbing touch-none rounded-full ${className}`}
                        style={style}
                >
