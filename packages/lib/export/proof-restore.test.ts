...
import { exportFingerprint, type FingerprintPose, proofFingerprint } from './export-fingerprint';
import { type ProofExportOptions, selectExportSnapshot } from './proof-inputs';
