import { DEFAULT_BACKDROP_COLOR, DEFAULT_SHELL_COLOR } from "@ipod/lib/domain/color-manifest";
import { DEFAULT_HARDWARE_PRESET_ID, getIpodClassicPreset } from "@ipod/lib/domain/ipod-classic-presets";
