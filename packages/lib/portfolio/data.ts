...
export const profile: PortfolioProfile = {
	...
	longBio: 'Formally trained Software Engineer turned Artist & self-taught Designer with 8+ years crafting delight through impactful interfaces, experiences & artifacts. My practice applies computational techniques to augment the design & art-direction process. Building tools and experiences with 1 billion people in mind.',
	summary: 'Polymath engineer at the convergence of software, film, music, and design. Formally trained at Cooper Union and FAMU Prague, with production experience spanning B2B product engineering, simultaneous translation across 4 languages, community radio, and EU-funded filmmaking.',
	location: 'NYC / PRAGUE',
...
export const processPhases: ProcessPhase[] = [
	{
		...
		detail: 'Start wide: collect references, talk to people, map constraints and the actual job-to-be-done. Computational tools augment the search — scraping, clustering, moodboarding — but the goal is a sharp problem statement before a single pixel.',
	},
	{
		title: 'Prototype',
		summary: 'Make the roughest thing that proves the idea.',
		detail: "Build the crudest artifact that can be felt: a clickable sketch, a shader toy, a paper cut-out. Optimize for learning per hour, not polish. Throwaway code is fine — the prototype's only job is to kill or confirm the direction.",
	},
	{
		title: 'Refine',
		summary: 'Tighten contour, weight, motion, and detail.',
		detail: 'Once the idea holds, obsess over the invisible details: spacing, easing, contrast, the half-pixel. This is where craft lives — diffing against the real reference until it feels inevitable rather than designed.',
	},
	{
		title: 'Ship',
		summary: 'Get it in front of people; measure; iterate.',
		detail: 'Ship to learn. Instrument it, watch real use, and treat launch as the start of the loop, not the end. Growth is the feedback signal that re-opens Research.',
	},
];
...
export const writings: Writing[] = [
	{
		...
		date: '2026-04-10',
		excerpt: 'A deep dive into using WebGPU compute shaders for real-time generative art.',
	...
	},
	{
		...
		date: '2026-03-25',
		excerpt: 'How we ported our portfolio logic to Clojure (Squint) while keeping Svelte 5 for rendering.',
	...
	},
	{
		...
		date: '2024-11-15',
		excerpt: 'GPGPU on the web, demystified — how to think in workgroups and parallel dispatch.',
	...
	},
	{
		...
		date: '2024-10-30',
		excerpt: 'Less ceremony, more output. A pragmatic account of moving a portfolio off React.',
	...
	},
	{
		...
		date: '2024-09-15',
		excerpt: 'Why monospace brutalism keeps coming back, and how to use it without cosplay.',
...
export const hiringPhilosophy = 'The more you leave out, the more you magnify what remains.';
...
export const proofPillars: ProofPillar[] = [
	...
	},
	{
		...
		detail: 'Real-time backends, admin-controlled content, and design systems that scale from 320px to 4K — this iPod included.',
	},
];
...
export const contactLinks: PortfolioLink[] = [
	{
		label: 'Email',
		url: `mailto:${profile.email}?subject=${encodeURIComponent('Hiring — Stüssy Senik')}`,
	},
	{ label: 'LinkedIn', url: 'https://www.linkedin.com/in/mxzou' },
	{ label: 'GitHub', url: 'https://github.com/stussysenik' },
	{ label: 'X / Twitter', url: 'https://x.com/mx_zou' },
