...
export const liveTheme = createTheme(vars, {
	material: {
		...
		chamferShadow:
			'inset 0 1px 0 rgba(255,255,255,0.65), inset 0 -1.5px 3px rgba(0,0,0,0.14)',
		specularSheen:
...
export const captureTheme = createTheme(vars, {
	material: {
		...
		chamferShadow:
			'inset 0 1px 0 rgba(255,255,255,0.5), inset 0 -1px 1px rgba(0,0,0,0.1)',
		specularSheen:
			'linear-gradient(162deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 50%)',
