...
import { IPOD_CLASSIC_PRESETS } from "@ipod/lib/domain/ipod-classic-presets";
import { FEATURE_FLAGS } from "@ipod/lib/services/feature-flags";
import { findKumuPaletteProximityMatches } from "@ipod/lib/support/color-proximity";
import type { BatteryMode, IpodHardwarePresetId, IpodInteractionModel } from "@ipod/lib/state/ipod-state/model";
import { Settings, Check, ChevronRight } from "lucide-react";
import { IconButton } from "@ipod/components/ui/icon-button";
import { cva, type VariantProps } from "class-variance-authority";
import { cn } from "@ipod/lib/support/utils";
