...
import { getExportPreset, type ExportPresetId } from "@ipod/lib/services/export/export-scene";
				...
				<div className="flex flex-col gap-3 rounded-[24px] border border-black/10 bg-white/80 p-4">
					...
					{error ? (
						...
						<p className="text-xs leading-5 text-[#4B5563]">
							The image area is intentionally clean. Use
							this view or the pop-out window if GIF
							download fails and you need a manual screen
							recording fallback.
						</p>
					)}
				</div>
