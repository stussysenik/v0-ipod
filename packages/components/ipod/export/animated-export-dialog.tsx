...
import { Film, Gauge, Maximize, Square, Video, X, Zap } from 'lucide-react';
						...
						<>
							<div className="flex items-start justify-between gap-4">
								<div>
									...
									<Heading
										slot="title"
										className="mt-2 text-2xl font-bold text-[#111827] tracking-tight"
									>
										Record sequence
									</Heading>
									<Text
							...
							<div className="mt-8 grid grid-cols-2 gap-4">
								<div className="flex flex-col gap-2">
									<Label className="text-[10px] font-bold uppercase tracking-widest text-[#6B7280] px-1">
										Format
									</Label>
										...
										<Button
											...
											className={cn(
												...
												format ===
													...
													: 'bg-white border-[#D0D4DA] text-[#6B7280] hover:bg-white/80',
											)}
										>
								...
								<div className="flex gap-2 mt-2">
									<Button
										...
										className={cn(
											...
											quality ===
												'standard'
												? 'bg-white border-[#111827] shadow-sm text-[#111827]'
												: 'bg-transparent border-transparent text-[#6B7280] hover:bg-black/5',
										)}
									>
										...
										<SliderOutput className="text-3xl font-bold tabular-nums text-[#111827]">
											{({
												...
												<>
													...
													<span className="ml-1.5 text-[10px] font-bold uppercase tracking-widest text-[#6B7280]">
														sec
													</span>
												</>
											)}
