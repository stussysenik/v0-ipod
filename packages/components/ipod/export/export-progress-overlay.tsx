...
import { Loader2, CheckCircle2, AlertCircle, Share2, Download } from "lucide-react";
...
export function ExportProgressOverlay({
	...
	const isVisible = stage !== "idle" as any;
			...
			<div className={cardVariants({ visible: isVisible })}>
				<div className="flex flex-col items-center text-center">
					<div className="mb-6 relative">
						...
						{isSuccess && <CheckCircle2 className="h-12 w-12 text-green-600 animate-in zoom-in duration-500" />}
						{isError && <AlertCircle className="h-12 w-12 text-red-600 animate-in shake duration-500" />}
					</div>
