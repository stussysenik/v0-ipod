...
import type { BatteryMode, IpodHardwarePresetId } from '@ipod/lib/ipod-state/model';
...
export function SettingsPanelBody() {
	...
	const hardwarePreset = IpodStoreContext.useSelector(
		(s) => s.context.presentation.hardwarePreset,
	);
	const interactionModel = IpodStoreContext.useSelector(
		(s) => s.context.interaction.interactionModel,
	);
	const batteryLevel = IpodStoreContext.useSelector(
		(s) => s.context.interaction.batteryLevel,
	);
