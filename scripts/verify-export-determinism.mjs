	...
	try {
		...
		const cross = {
			placeholderDesktopVsMobile:
				desktopPlaceholder.first.blobDigest ===
					mobilePlaceholder.first.blobDigest &&
				desktopPlaceholder.first.blobSize ===
					mobilePlaceholder.first.blobSize,
			snapshotDesktopVsMobile:
				desktopSnapshot.first.blobDigest ===
					mobileSnapshot.first.blobDigest &&
